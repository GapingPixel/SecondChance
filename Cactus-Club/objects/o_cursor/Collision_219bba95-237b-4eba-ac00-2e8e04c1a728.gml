...
if (!instance_exists(o_description)) {
	create_description("A nearly full pack of cigarettes of the SEAGULL brand.", 1 o_inventory.x+450, o_inventory.y+28);
	show_des = 1;
}
...
if (mouse_check_button_pressed(mb_left)) {
	...
	if state.chat {
		...
		scr_text("That has nothing to do with tuna salad.",01view_xport[0]+125,view_yport[0]+250,CHEST_GRACE);
